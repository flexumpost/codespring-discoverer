...
const MAIL_PRICING_DEFAULTS: Record<string, Record<string, string>> = {
  Lite: { forklaring: "## Standard handling\n- **Scanning:** Gratis hver den 1. torsdag i måneden.\n- **Afhentning:** Gratis afhentning hver den 1. torsdag i måneden.\n- **Forsendelse:** Gratis forsendelse hver den 1. torsdag i måneden (forsendelsen tillægges porto)\n\n## Ekstra handling\n**Priser jvf. nedenstående.**\n- **Scanning:** Kan scannes tirsdag eller torsdag. Gebyret afregnes pr. brev.\n- **Afhentning:** Kan afhentes tirsdag eller torsdag. (Skal bookes) Gebyret afregnes pr. afhentning uanset antal breve.\n- **Forsendelse:** Kan sendes ekstra hver torsdag.", forsendelsesdag: "Hver den 1. torsdag i måneden", ekstraForsendelse: "50 kr. — kan sendes ekstra hver torsdag", ekstraScanning: "50 kr. pr. brev — kan scannes tirsdag eller torsdag", ekstraAfhentning: "50 kr. pr. afhentning — kan afhentes tirsdag eller torsdag (Skal bookes)" },
  Standard: { forklaring: "## Standard handling\n- **Scanning:** Gratis hver torsdag.\n- **Afhentning:** Gratis afhentning hver torsdag.\n- **Forsendelse:** Gratis forsendelse hver torsdag (forsendelsen tillægges porto)\n\n## Ekstra handling\n**Priser jvf. nedenstående.**\n- **Scanning:** Kan scannes alle hverdage. Gebyret afregnes pr. brev.\n- **Afhentning:** Kan afhentes tirsdag eller torsdag. (Skal bookes) Gebyret afregnes pr. afhentning uanset antal breve.", forsendelsesdag: "Hver torsdag", ekstraForsendelse: "Inkluderet i standard", ekstraScanning: "30 kr. pr. brev — kan scannes alle hverdage", ekstraAfhentning: "30 kr. pr. afhentning — kan afhentes tirsdag eller torsdag (Skal bookes)" },
