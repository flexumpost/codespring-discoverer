...
BEGIN
  -- NOTE: sendt_med_dao / sendt_med_postnord are now handled by sync-officernd-charge-batch
  -- called explicitly from the shipping page to consolidate charges per tenant.
