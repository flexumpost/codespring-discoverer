...
export const WelcomeShipmentEmail = ({
  ...
  // Escape & to &amp; for valid HTML href attributes in dangerouslySetInnerHTML
...
<!--[if mso]>
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${safeUrl}" style="height:44px;v-text-anchor:middle;width:260px;" arcsize="18%" stroke="f" fillcolor="#00aaeb">
<w:anchorlock/>
<center style="color:#ffffff;font-family:Arial,sans-serif;font-size:14px;font-weight:600;">Sæt din adgangskode →</center>
</v:roundrect>
<![endif]-->
<!--[if !mso]><!-->
<a href="${safeUrl}" style="background-color:#00aaeb;color:#ffffff;font-size:14px;font-weight:600;border-radius:0.5rem;padding:12px 24px;text-decoration:none;display:inline-block;mso-line-height-rule:exactly;">Sæt din adgangskode →</a>
<!--<![endif]-->
          ` }} />
