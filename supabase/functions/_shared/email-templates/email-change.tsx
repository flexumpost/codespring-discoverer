...
export const EmailChangeEmail = ({
  ...
  <Html lang="da" dir="ltr">
    ...
    <Preview>Bekræft ændring af din e-mail hos Flexum Coworking</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Du har anmodet om at ændre din e-mailadresse hos <strong>Flexum Coworking</strong> fra <strong>{oldEmail}</strong> til <strong>{newEmail}</strong>.
        </Text>
